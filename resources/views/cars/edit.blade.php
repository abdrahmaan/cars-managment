    ...
    <div class="row">
        ...
        <div class="col-12">
            <form id="new-car" action="/edit-car/{{$Data->id}}" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-start flex-row-reverse">
                            <!-- ماركة السيارة -->
                                <div class="col-lg-3">
                                    <div class="form-group mx-2 d-block">
                                        <label for="Brand" class="text-right w-100">ماركة السيارة</label>
                                        <select name="Brand" class="form-control text-right" style="">
                                            <option disabled value="">الإختيار المحدد</option>
                                            <option value="{{$Data->Brand}}">{{$Data->Brand}}</option>
                                            <option disabled value="">الإختيارات المتاحة</option>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group  mx-2 d-block">
                                    <label for="ModelName" class="text-right w-100">إسم الموديل</label>
                            ...
                            <div class="col-lg-3">
                                    <div class="form-group  mx-2 d-block">
                                        <label for="ModelType" class="text-right w-100">نوع الموديل</label>
                ...
                <div class="card">
                    <div class="card-header d-flex flex-row-reverse">   
                        <h3 class="card-title">بيانات المحرك</h3>
                    <div class="card-tools mx-3">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                        <i class="fas fa-minus"></i>
                        </button>
                    ...
                    <div class="card-body">
                        <div class="row justify-content-start flex-row-reverse">
                            <!-- نوع الإنتقال  -->
                                <div class="col-lg-3">
                                    <div class="form-group mx-2 d-block">
                                        <label for="Transmission" class="text-right w-100">نوع الإنتقال</label>
                            ...
                            <!-- عدد الإنتقالات -->
                                <div class="col-lg-3">
                                <div class="form-group mx-2 d-block">
                                        <label for="TransmissionCount" class="text-right w-100">عدد الإنتقالات</label>
                            ...
                            <!-- 4X4 -->
                                <div class="col-lg-3">
                                <div class="form-group mx-2 d-block">
                                        <label for="FourXFour" class="text-right w-100">4X4/4X2</label>
                            ...
                            <!-- نوع الدفع -->
                                <div class="col-lg-3">
                                <div class="form-group mx-2 d-block">
                                        <label for="PushingType" class="text-right w-100">نوع الدفع</label>
                            ...
                            <!-- عدد CC  -->
                                <div class="col-lg-3">
                                        <div class="form-group  mx-2 d-block">
                                            <label for="CC" class="text-right w-100">CC</label>
                            ...
                            <!-- عدد السليندر -->
                                <div class="col-lg-3">
                                    <div class="form-group mx-2 d-block">
                                        <label for="Cylinder" class="text-right w-100">عدد السليندر</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group mx-2 d-block">
                                        <label for="FuelType" class="text-right w-100">نوع التانك</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group  mx-2 d-block">
                                    <label for="FuelLiter" class="text-right w-100">عدد الليترات/تانك</label>
                ...
                <div class="card">
                    <div class="card-header d-flex flex-row-reverse">   
                        <h3 class="card-title">أبعاد السيارة</h3>
                    <div class="card-tools mx-3">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                        <i class="fas fa-minus"></i>
                        </button>
                    ...
                    <div class="card-body">
                        <div class="row justify-content-start flex-row-reverse">
                            ...
                            <!-- طول  -->
                                <div class="col-lg-3">
                                        <div class="form-group  mx-2 d-block">
                                            <label for="Height" class="text-right w-100">الطول</label>
                            ...
                            <!-- عرض  -->
                                <div class="col-lg-3">
                                        <div class="form-group  mx-2 d-block">
                                            <label for="Width" class="text-right w-100">العرض</label>
                            ...
                            <!-- إرتفاع  -->
                                <div class="col-lg-3">
                                        <div class="form-group  mx-2 d-block">
                                            <label for="Length" class="text-right w-100">الإرتفاع</label>
                            ...
                            <!-- مقاس الكاوتش  -->
                                <div class="col-lg-3">
                                        <div class="form-group  mx-2 d-block">
                                            <label for="Tier" class="text-right w-100">مقاس الكاوتش</label>
                            ...
                            <!-- عدد الركاب -->
                                <div class="col-lg-3">
                                <div class="form-group mx-2 d-block">
                                        <label for="Passengers" class="text-right w-100">عدد الركاب</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group  mx-2 d-block">
                                    <label for="PurchasePrice" class="text-right w-100">سعر الشراء</label>
